...
Robert Morris una notte scrive un programma C che sfrutta il buffer overflow su sunOS. Nel giro di un'ora il suo internet warm ha messo fuori uso il 10% di internet. C'era un bug nel codice, ovvero non controllava se la macchina infettata non fosse già infettata. 
